const welcome = (email, USER, PASSWORD) => {
    const URL = ""
    return `
    <!DOCTYPE html>
    <html lang="en">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span
                                            style="color:#fff; font-size: 30px">Welcome To CRSAPI</span> </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                                            ...
                                                            <table role="presentation" align="center" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="border-radius: 50px; background: #26a4d3; text-align: center;"
                                                                        class="button-td"> <a
                                                                            href="https://documenter.getpostman.com/view/9285706/SzfCTRRf?version=latest"
                    ...
                    <tr>
                        <td bgcolor="#ffffff">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 0px 40px 20px 40px; font-family: sans-serif;
                                         font-size: 15px; line-height: 20px; color: #555555; text-align: left; 
                                         font-weight:bold;">
                                        <p style="margin: 0;">API PRIVATE KEY FOR DEVELOPMENT</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0px 40px 20px 40px;  font-weight:bold;
                                         font-family: sans-serif; font-size: 20PX;
                                          line-height: 20px; color: #ffffff;background-color:rgba(37, 165, 80, 0.856) ; text-align: left;
                                           font-weight:normal;">
                                        <br>
                                        <br>
                                        <label>USERNAME : ${USER}</label><br><br>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"> <br>
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p style="margin: 0;">Copyright &copy; 2020-2021 <b>codetodev.com</b>, All Rights
                                            Reserved.</p>
                                    </td>
                                </tr>
                            </table>
