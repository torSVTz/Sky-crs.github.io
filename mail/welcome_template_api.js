                                                            ...
                                                            <table role="presentation" align="center" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="border-radius: 50px; background: #26a4d3; text-align: center;"
                                                                        class="button-td"> <a href="https://documenter.getpostman.com/view/9285706/SzfCTRRf?version=latest"
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        white-space:pre-wrap;padding: 10px; border-radius: 10px;width: 100%;color: rgb(255, 0, 0);background:#1b1a1a ;">${token}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
